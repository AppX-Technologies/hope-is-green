...
export default function ClubSettingForm({ initialValues, onSubmit }) {
          ...
          <div>
            <div className="flex justify-end">
              <Button
                ...
                text={'Update'}
                type="submit"
                className={`bg-primary hover:bg-green-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline`}
              />
            </div>
